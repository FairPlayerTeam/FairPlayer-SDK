...
The **FairPlayer** name can only be used to uniquely identify Android applications that are fully compatible with the **FairPlayer Music Player** application in accordance with the **[FairPlayer Theme SDK Licenses](https://fairplayerteam.github.io/FairPlayer-SDK/Licenses)**.
